...
using CapitalPlacementTaskAPI.Business.Extensions;
using CapitalPlacementTaskAPI.Infrastructure.Persistence.Context;
using CapitalPlacementTaskAPI.Middleware;
using MediatR;
...
//builder.WebHost.UseUrls("http://*:8061");
// Logging
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "BPMSolution-Service", Version = "v1" });
...
var counter = Metrics.CreateCounter("omnischeduler_path_counter", "Counts requests to the omni scheduler API endpoints", new CounterConfiguration
{
